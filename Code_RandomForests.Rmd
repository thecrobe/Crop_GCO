...
# Model Performance
predictions.val <- predict(fit.rf.barley, validation) #predict 
...
predictions.barley <- data.frame(10^(predict(fit.rf.barley, rf )-1)) #predict on whole dataset
summary(predictions.barley) 
barley.residuals<-rf$barley_HgHa-predictions.barley
hist(barley.residuals)
