...
#AET
Potato.aet<-perm.relation(rf.Potato$mean_potat,rf.Potato$AET_mean,method = "pearson") 
#print(Potato.aet)

#GDP
Potato.gdp<-perm.relation(rf.Potato$Potato_HgHa,rf.Potato$GDP_Mean,method = "pearson") 
#print(Potato.gdp)

#Pest
Potato.pest<-perm.relation(rf.Potato$Potato_HgHa,rf.Potato$Pesticide,method = "pearson") 
#print(Potato.pest)

#Fertilizer
Potato.fert<-perm.relation(rf.Potato$Potato_HgHa,rf.Potato$Potato_Fertilizer,method = "pearson")
#print(Potato.fert)
```
