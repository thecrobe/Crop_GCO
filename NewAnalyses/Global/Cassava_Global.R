...
#Some covariates
cassava.model<-na.omit(read.csv(file="Crop_GCO/Global/Models/Cassava_RF.csv", header=T))
...
write.csv(cassava.spatial$predictions, file="Crop_GCO/Global/ModelOutputs/cassava_pred.csv")
write.csv(cassava.spatial$residuals$values, file="Crop_GCO/Global/ModelOutputs/cassava_resid.csv")
write.csv(cassava.spatial$variable.importance, file="Crop_GCO/Global/ModelOutputs/cassava_VarImp.csv")
write.csv(cassava.spatial$performance, file="Crop_GCO/Global/ModelOutputs/cassava_preformance.csv")
write.csv(cassava.curves.df, file="Crop_GCO/Global/ModelOutputs/cassava_curves.csv")
