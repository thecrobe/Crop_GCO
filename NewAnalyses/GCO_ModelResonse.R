...
#barley
barley.real<-na.omit(read.csv(file="Models/Barley_RF.csv"))
barley.real$FISHNET_ID<-barley.real$Fishnet_ID
   
barley.pred<-read.csv(file="NewAnalyses/Global/ModelOutputs/barley_pred.csv",header=T)
...
#cassava
cassava.real<-na.omit(read.csv(file="Models/Cassava_RF.csv"))
cassava.real$FISHNET_ID<-cassava.real$Fishnet_ID

cassava.pred<-read.csv(file="NewAnalyses/Global/ModelOutputs/cassava_pred.csv",header=T)
...
#groundnut
groundnut.real<-na.omit(read.csv(file="Models/Groundnut_RF.csv"))
groundnut.real$FISHNET_ID<-groundnut.real$Fishnet_ID

groundnut.pred<-read.csv(file="NewAnalyses/Global/ModelOutputs/groundnut_pred.csv",header=T)
...
#maize
maize.real<-na.omit(read.csv(file="Models/Maize_RF.csv"))
maize.real$FISHNET_ID<-maize.real$Fishnet_ID

maize.pred<-read.csv(file="NewAnalyses/Global/ModelOutputs/maize_pred.csv",header=T)
...
#potato
potato.real<-na.omit(read.csv(file="Models/Potato_RF.csv"))
potato.real$FISHNET_ID<-potato.real$Fishnet_ID

potato.pred<-read.csv(file="NewAnalyses/Global/ModelOutputs/potato_pred.csv",header=T)
...
#rapeseed
rapeseed.real<-na.omit(read.csv(file="Models/Rapeseed_RF.csv"))
rapeseed.real$FISHNET_ID<-rapeseed.real$Fishnet_ID

rapeseed.pred<-read.csv(file="NewAnalyses/Global/ModelOutputs/rapeseed_pred.csv",header=T)
...
#Rice
Rice.real<-na.omit(read.csv(file="Models/Rice_RF.csv"))
Rice.real$FISHNET_ID<-Rice.real$Fishnet_ID

Rice.pred<-read.csv(file="NewAnalyses/Global/ModelOutputs/Rice_pred.csv",header=T)
...
#Rye
Rye.real<-na.omit(read.csv(file="Models/Rye_RF.csv"))
Rye.real$FISHNET_ID<-Rye.real$Fishnet_ID

Rye.pred<-read.csv(file="NewAnalyses/Global/ModelOutputs/Rye_pred.csv",header=T)
...
#Sorghum
Sorghum.real<-na.omit(read.csv(file="Models/Sorghum_RF.csv"))
Sorghum.real$FISHNET_ID<-Sorghum.real$Fishnet_ID

Sorghum.pred<-read.csv(file="NewAnalyses/Global/ModelOutputs/Sorghum_pred.csv",header=T)
...
#Soybean
Soybean.real<-na.omit(read.csv(file="Models/Soybean_RF.csv"))
Soybean.real$FISHNET_ID<-Soybean.real$Fishnet_ID

Soybean.pred<-read.csv(file="NewAnalyses/Global/ModelOutputs/Soybean_pred.csv",header=T)
...
#Sunflower
Sunflower.real<-na.omit(read.csv(file="Models/Sunflower_RF.csv"))
Sunflower.real$FISHNET_ID<-Sunflower.real$Fishnet_ID

Sunflower.pred<-read.csv(file="NewAnalyses/Global/ModelOutputs/Sunflower_pred.csv",header=T)
...
#Wheat
Wheat.real<-na.omit(read.csv(file="Models/Wheat_RF.csv"))
Wheat.real$FISHNET_ID<-Wheat.real$Fishnet_ID

Wheat.pred<-read.csv(file="NewAnalyses/Global/ModelOutputs/Wheat_pred.csv",header=T)
