...
<div class = "col-md-4">
<br><br> **What This Allows Me To Do:** Identify if yield-distance relationships (near analysis) are a function of fertilizer input. 
</div>
...
#Import Fishnet
fishnet<- readOGR(dsn= "/Users/justinstewart/Dropbox/Collaborations/TobyKiers/Crop_Productivity_GCO/Analysis/GIS/Near_Fertilizer/", layer="FertNear")
...
## Barley 
```{r,  message=TRUE, warning=FALSE, cache=TRUE, message=FALSE}
barley<- readOGR(dsn= "/Users/justinstewart/Dropbox/Collaborations/TobyKiers/Crop_Productivity_GCO/Analysis/GIS/GCO_Shapefiles/", layer="BarleyWheat_GC") #Import GCO Centroid
plot(barley)
barley.c<-gCentroid(barley) #Extract Lat-Long
...
## Cassava 
```{r,  message=TRUE, warning=FALSE, cache=TRUE, message=FALSE}
cassava<- readOGR(dsn= "/Users/justinstewart/Dropbox/Collaborations/TobyKiers/Crop_Productivity_GCO/Analysis/GIS/GCO_Shapefiles/", layer="Cassava_GC") #Import GCO Centroid
cassava.c<-gCentroid(cassava) #Extract Lat-Long
...
## Groundnut 
```{r,  message=TRUE, warning=FALSE, cache=TRUE, message=FALSE}
groundnut<-readOGR(dsn= "/Users/justinstewart/Dropbox/Collaborations/TobyKiers/Crop_Productivity_GCO/Analysis/GIS/GCO_Shapefiles/", layer="Groundnut_GC") #Import GCO Centroid
groundnut.c<-gCentroid(groundnut) #Extract Lat-Long
...
## Sorghum 
```{r,  message=TRUE, warning=FALSE, cache=TRUE, message=FALSE}
sorghum<- readOGR(dsn= "/Users/justinstewart/Dropbox/Collaborations/TobyKiers/Crop_Productivity_GCO/Analysis/GIS/GCO_Shapefiles/", layer="Sorghum_GC") #Import GCO Centroid
sorghum.c<-gCentroid(sorghum) #Extract Lat-Long
...
## Soybean 
```{r,  message=TRUE, warning=FALSE, cache=TRUE, message=FALSE}
soybean<- readOGR(dsn= "/Users/justinstewart/Dropbox/Collaborations/TobyKiers/Crop_Productivity_GCO/Analysis/GIS/GCO_Shapefiles/", layer="Soy_GC") #Import GCO Centroid
soybean.c<-gCentroid(soybean) #Extract Lat-Long
...
## Wheat 
```{r,  message=TRUE, warning=FALSE, cache=TRUE, message=FALSE}
wheat<- readOGR(dsn= "/Users/justinstewart/Dropbox/Collaborations/TobyKiers/Crop_Productivity_GCO/Analysis/GIS/GCO_Shapefiles/", layer="BarleyWheat_GC") #Import GCO Centroid
wheat.c<-gCentroid(wheat) #Extract Lat-Long
...
ggplot(data, aes(x=rescale_ND,y=log10(data$wheat_Fert))) + 
      ...
      ylab("Log10 Fertilizer") + 
      xlab("Distance From GCO (1000's km)") +
      geom_abline(aes(intercept=coef(wheat.ConstPower)[1], slope=coef(wheat.ConstPower)[2]), color="red", size=2)
...
summary(wheat.ConstPower)
```

## Maize 
```{r,  message=TRUE, warning=FALSE, cache=TRUE, message=FALSE}
maize<- readOGR(dsn= "/Users/justinstewart/Dropbox/Collaborations/TobyKiers/Crop_Productivity_GCO/Analysis/GIS/GCO_Shapefiles/", layer="Maize_GC") #Import GCO Centroid
maize.c<-gCentroid(maize) #Extract Lat-Long
...
## Rapeseed 
```{r,  message=TRUE, warning=FALSE, cache=TRUE, message=FALSE}
rapeseed<- readOGR(dsn= "/Users/justinstewart/Dropbox/Collaborations/TobyKiers/Crop_Productivity_GCO/Analysis/GIS/GCO_Shapefiles", layer="Rapeseed") #Import GCO Centroid
rapeseed.c<-gCentroid(rapeseed) #Extract Lat-Long
...
## Rice 
```{r,  message=TRUE, warning=FALSE, cache=TRUE, message=FALSE}
rice<- readOGR(dsn= "/Users/justinstewart/Dropbox/Collaborations/TobyKiers/Crop_Productivity_GCO/Analysis/GIS/GCO_Shapefiles/", layer="Rice_GC1") #Import GCO Centroid
rice.c<-gCentroid(rice) #Extract Lat-Long
...
## Rye 
```{r,  message=TRUE, warning=FALSE, cache=TRUE, message=FALSE}
rye<- readOGR(dsn= "/Users/justinstewart/Dropbox/Collaborations/TobyKiers/Crop_Productivity_GCO/Analysis/GIS/GCO_Shapefiles/", layer="Rye") #Import GCO Centroid
rye.c<-gCentroid(rye) #Extract Lat-Long
...
## Sunflower 
```{r,  message=TRUE, warning=FALSE, cache=TRUE, message=FALSE}
sunflower<- readOGR(dsn= "/Users/justinstewart/Dropbox/Collaborations/TobyKiers/Crop_Productivity_GCO/Analysis/GIS/GCO_Shapefiles/", layer="Sunflower_GC") #Import GCO Centroid
sunflower.c<-gCentroid(sunflower) #Extract Lat-Long
