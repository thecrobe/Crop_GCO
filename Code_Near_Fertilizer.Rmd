...
ggplot(data, aes(x=rescale_ND,y=log10(data$barley_Fer))) + 
      ...
      geom_smooth(method="lm", color="red") +xlab("Distance From GCO (1000's km)") +ylab ("Log10 Fertilizer Input") + geom_abline(aes(intercept=coef(barley.power)[1], slope=coef(barley.power)[2]), color="blue")
...
ggplot(data, aes(x=rescale_ND,y=log10(data$cassava_Fe))) + 
      ...
      geom_smooth(method="lm", color="red") +xlab("Distance From GCO (1000's km)") +ylab ("Log10 Fertilizer Input") + geom_abline(aes(intercept=coef(cassava.exp)[1], slope=coef(cassava.exp)[2]), color="blue")
