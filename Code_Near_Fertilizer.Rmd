...
library(maptools)
library(rgeos)
fishnet<- readOGR(dsn= "/Users/justinstewart/Dropbox/Collaborations/TobyKiers/Crop_Productivity_GCO/Analysis/GIS/Near_Fertilizer/", layer="Near_Fert.")
...
```{r,  message=TRUE, warning=FALSE, cache=TRUE, message=FALSE}
barley.wheat<- readOGR(dsn= "/Users/justinstewart/Dropbox/Collaborations/TobyKiers/Crop_Productivity_GCO/Analysis/GIS/GCO_Shapefiles/", layer="Barley_Wheat")
plot(barley.wheat) #check her!
barley.wheat.centr <- gCentroid(barley.wheat, byid = FALSE) #calculate centroid
