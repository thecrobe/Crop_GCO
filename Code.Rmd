...
## Prediction Outlier Removal

<div class = "col-md-4">
<br><br> **What Was Tested:** What is the distribution of predictions from RF models? The models overpredict in a small number of pixels. Identfying them and remomving them is important as it allows  
</div>

<div class = "col-md-4">
<br><br> **What This Allows Me To Do:** The models overpredict in a small number of pixels. Identfying them and remomving them is important as it allows for vizualization of quantiles that are centered closer to the mean. Outliers will be coded in black on the maps. 
</div>

<div class = "col-md-4">
<br><br> **What Are The Model Assumptions:** Model means are normall
</div>
```{r,fig.align='center',message=FALSE, warning=FALSE, cache=TRUE}
```
