...
barley.gls.exp <- gls(mean_barle ~ NEAR_DIST,, data = barley.near, weights = varExp())
summary(barley.gls.exp) #AIC = 36225.58
plot(barley.gls.exp) #plot residuals
hist(residuals(barley.gls.exp)) #residual histogram
...
#Identity - Log Transformation
barley.near$logYield<-log10(barley.near$mean_barle)
barley.gls.exp.ident <- gls(logYield ~ NEAR_DIST,, data = barley.near, weights = varIdent())
summary(barley.gls.exp.ident) #AIC = 18587.88
plot(barley.gls.exp.ident) #plot residuals
hist(residuals(barley.gls.exp.ident)) #residual histogram
...
### OLS regression
cassava.near.ols<-lm(mean_cassa ~ NEAR_DIST,, data = cassava.near)
summary(cassava.near.ols)
plot(cassava.near.ols)
hist(residuals(cassava.near.ols))
AIC(cassava.near.ols) #AIC = 28314.04

### GLS Regression
library(nlme)

#Exponential - No Transformation
cassava.gls.exp <- gls(mean_cassa ~ NEAR_DIST,, data = cassava.near, weights = varExp())
summary(cassava.gls.exp) #AIC = 28309.16	
plot(cassava.gls.exp) #plot residuals
...
#Identity - Log Transformation
cassava.near$logYield<-log10(cassava.near$mean_cassa)
cassava.gls.exp.ident <- gls(logYield ~ NEAR_DIST,, data = cassava.near, weights = varIdent())
summary(cassava.gls.exp.ident) #AIC = 6329.558	
plot(cassava.gls.exp.ident) #plot residuals
hist(residuals(cassava.gls.exp.ident)) #residual histogram
