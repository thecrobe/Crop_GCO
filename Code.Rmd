...
#Growing
rapeseed.growing<-perm.relation(rf.rapeseed$rapeseed_HgHa,rf.rapeseed$Growing_Mean,method = "pearson") 
...
ggplot(vard.m, aes(x=vard.m$Crop, y=vard.m$variable, fill=vard.m$value)) +geom_tile() + theme_bw() +theme(axis.line = element_line(colour = "black"),
    ...
    panel.border = element_blank(),
    panel.background = element_blank()) + 
  ylab("Crop") +xlab("Variable") + labs(color='Rho') +scale_fill_gradient(low="white", high="#006669") +theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
