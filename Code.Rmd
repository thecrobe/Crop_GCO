...
barley<-read.csv(file = "Models/Error/Barley_Error.csv", header=T)
barley3sd<-read.csv(file="Models/Error/Barley_Error_3SD.csv", header=T)
dim(barley)-dim(barley3sd)


ggplot(barley, aes(x=log10(Barley_Error_Ratio)))+geom_density(size=0.9, color="#004F86")+geom_vline(xintercept = 1,size=1.5, color="#CE271D") +theme_bw() +theme(axis.line = element_line(colour = "black"),panel.grid.major = element_blank(),panel.grid.minor = element_blank(),panel.border = element_blank(),panel.background = element_blank()) +xlab("Model Error") +ylab ("Kernal Density")


cassava<-read.csv(file = "Models/Error/Cassava_Error.csv", header=T)

cassava3sd<-read.csv(file = "Models/Error/Cassava_Error_3SD.csv", header=T)

dim(cassava)-dim(cassava3sd)


ggplot(cassava3sd, aes(x=Cassava_Error_Ratio))+geom_density(size=0.9, color="#004F86")+geom_vline(xintercept = 1,size=1.5, color="#CE271D") +theme_bw() +theme(axis.line = element_line(colour = "black"),panel.grid.major = element_blank(),panel.grid.minor = element_blank(),panel.border = element_blank(),panel.background = element_blank()) +xlab("Model Error") +ylab ("Kernal Density")


groundnut3sd<-read.csv(file = "Models/Error/Groundnut_Error_3SD.csv", header=T)

groundnut<-read.csv(file = "Models/Error/Groundnut_Error.csv", header=T)

dim(groundnut)-dim(groundnut3sd)
