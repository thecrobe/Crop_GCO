...
barley.perm<-(barley.inside$barley_HgHa,barley.outside$barley_HgHa,progress=FALSE)
print(barley.perm)
```
...
plot(barley.varIMP)
write.csv(barley.varIMP, file = "Models/Variable_Importance/barley_varIMP.csv")
# Model Performance
...
plot(cassava.varIMP)
write.csv(cassava.varIMP, file = "Models/Variable_Importance/cassava_varIMP.csv")
# Model Performance
...
write.csv(groundnut.varIMP, file = "Models/Variable_Importance/groundnut_varIMP.csv")
# Model Performance
...
plot(maize.varIMP)
write.csv(maize.varIMP, file = "Models/Variable_Importance/maize_varIMP.csv")
# Model Performance
...
plot(millet.varIMP)
write.csv(millet.varIMP, file = "Models/Variable_Importance/millet_varIMP.csv")
# Model Performance
...
write.csv(rapeseed.varIMP, file = "Models/Variable_Importance/rapeseed_varIMP.csv")
# Model Performance
...
plot(rice.varIMP)
write.csv(rice.varIMP, file = "Models/Variable_Importance/rice_varIMP.csv")
# Model Performance
...
plot(rye.varIMP)
write.csv(rye.varIMP, file = "Models/Variable_Importance/rye_varIMP.csv")
# Model Performance
...
# create a list of 60% of the rows in the original dataset we can use for training
validation_index <- createDataPartition(rf$Sorghum_HgHa, p=0.60, list=FALSE)
# select 20% of the data for validation
validation <- rf[-validation_index,]
# use the remaining 60% of data to training and testing the models
dataset <- rf[validation_index,]     
...
# Random Forest
set.seed(7)
fit.rf.Sorghum <- train(Sorghum_HgHa~., data=dataset, method="rf", metric=metric, trControl=control) #remove # to run again
...
plot(Sorghum.varIMP)
write.csv(Sorghum.varIMP, file = "Models/Variable_Importance/Sorghum_varIMP.csv")
# Model Performance
...
plot(Soybean.varIMP)
write.csv(Soybean.varIMP, file = "Models/Variable_Importance/Soybean_varIMP.csv")
# Model Performance
...
write.csv(Sunflower.varIMP, file = "Models/Variable_Importance/Sunflower_varIMP.csv")
# Model Performance
...
plot(Wheat.varIMP)
write.csv(Wheat.varIMP, file = "Models/Variable_Importance/Wheat_varIMP.csv")
# Model Performance
...
<div class = "col-md-4">
<br><br> **What Are The Model Assumptions:** Spearman rank-order correlations are used and have the s
</div>
...
#AET
barely.aet<-perm.relation(rf.barley$barley_HgHa,rf.barley$AET_mean,method = "spearman") 
#Growing
barely.growing<-perm.relation(rf.barley$barley_HgHa,rf.barley$Growing_Mean,method = "spearman") 
#GDP
barely.gdp<-perm.relation(rf.barley$barley_HgHa,rf.barley$GDP_Mean,method = "spearman") 
#Pest
barely.pest<-perm.relation(rf.barley$barley_HgHa,rf.barley$Pesticide,method = "spearman") 
#Fertilizer
barely.fert<-perm.relation(rf.barley$barley_HgHa,rf.barley$Barley_Fertilizer,method = "spearman") 
...
#Fertilizer
cassava.fert<-perm.relation(rf.cassava$cassava_HgHa,rf.cassava$Cassava_Fertilizer,method = "spearman")
...
#AET
sorghum.aet<-perm.relation(rf.sorghum$Yieldrf.sorghum$AET_mean,method = "spearman") 
#Growing
sorghum.growing<-perm.relation(rf.sorghum$Yield,rf.sorghum$Growing.Season,method = "spearman") 
#GDP
sorghum.gdp<-perm.relation(rf.sorghum$Yield,rf.sorghum$GDP_Mean,method = "spearman") 
#Pest
