...
# Random Forest
set.seed(7)
fit.rf.barley <- train(dataset$barley_HgHa~., data=dataset, method="rf", metric=metric, trControl=control) #remove # to run again
print(fit.rf.barley) #print results

stopCluster(cl)

sorghum.varIMP<-(varImp(fit.rf.barley)) #identify variable importance
plot(barley.varIMP)
...
# Random Forest
set.seed(7)
fit.rf.cassava <- train(dataset$cassava_HgHa~., data=dataset, method="rf", metric=metric, trControl=control) #remove # to run again
print(fit.rf.cassava) #print results

stopCluster(cl)

sorghum.varIMP<-(varImp(fit.rf.cassava)) #identify variable importance
plot(cassava.varIMP)
...
# Random Forest
set.seed(7)
fit.rf.groundnut <- train(dataset$groundnut_HgHa~., data=dataset, method="rf", metric=metric, trControl=control) #remove # to run again
print(fit.rf.groundnut) #print results

stopCluster(cl)

sorghum.varIMP<-(varImp(fit.rf.groundnut)) #identify variable importance
...
# Random Forest
set.seed(7)
fit.rf.maize <- train(dataset$maize_HgHa~., data=dataset, method="rf", metric=metric, trControl=control) #remove # to run again
print(fit.rf.maize) #print results

stopCluster(cl)

sorghum.varIMP<-(varImp(fit.rf.maize)) #identify variable importance
plot(maize.varIMP)
...
# Random Forest
set.seed(7)
fit.rf.millet <- train(dataset$millet_HgHa~., data=dataset, method="rf", metric=metric, trControl=control) #remove # to run again
print(fit.rf.millet) #print results

stopCluster(cl)

sorghum.varIMP<-(varImp(fit.rf.millet)) #identify variable importance
plot(millet.varIMP)
...
# Random Forest
set.seed(7)
fit.rf.rapeseed <- train(dataset$rapeseed_HgHa~., data=dataset, method="rf", metric=metric, trControl=control) #remove # to run again
print(fit.rf.rapeseed) #print results

stopCluster(cl)

sorghum.varIMP<-(varImp(fit.rf.rapeseed)) #identify variable importance
...
# Random Forest
set.seed(7)
fit.rf.rice <- train(dataset$rice_HgHa~., data=dataset, method="rf", metric=metric, trControl=control) #remove # to run again
print(fit.rf.rice) #print results

stopCluster(cl)

sorghum.varIMP<-(varImp(fit.rf.rice)) #identify variable importance
plot(rice.varIMP)
...
# Random Forest
set.seed(7)
fit.rf.rye <- train(dataset$rye_HgHa~., data=dataset, method="rf", metric=metric, trControl=control) #remove # to run again
print(fit.rf.rye) #print results

stopCluster(cl)

sorghum.varIMP<-(varImp(fit.rf.rye)) #identify variable importance
plot(rye.varIMP)
...
# Random Forest
set.seed(7)
fit.rf.Sorghum <- train(dataset$Sorghum_HgHa~., data=dataset, method="rf", metric=metric, trControl=control) #remove # to run again
...
# Random Forest
set.seed(7)
fit.rf.Soybean <- train(dataset$Soybean_HgHa~., data=dataset, method="rf", metric=metric, trControl=control) #remove # to run again
...
# Random Forest
set.seed(7)
fit.rf.Sunflower <- train(dataset$Sunflower_HgHa~., data=dataset, method="rf", metric=metric, trControl=control) #remove # to run again
...
# Random Forest
set.seed(7)
fit.rf.Wheat <- train(dataset$Wheat_HgHa~., data=dataset, method="rf", metric=metric, trControl=control) #remove # to run again
