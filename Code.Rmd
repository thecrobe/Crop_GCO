...
write.csv(exp(modelerror)-1),file="Models/Predictions/barley_predictions.csv") # export for mapping
...
head(modelerror) #make sure it worked honeyyyy
write.csv(exp(modelerror)-1),file="Models/Predictions/cassava_predictions.csv") # export for mapping
...
head(modelerror) #make sure it worked honeyyyy
write.csv(exp(modelerror)-1),file="Models/Predictions/groundnut_predictions.csv") # export for mapping
...
head(modelerror) #make sure it worked honeyyyy
write.csv(exp(modelerror)-1),file="Models/Predictions/maize_predictions.csv") # export for mapping
...
head(modelerror) #make sure it worked honeyyyy
write.csv(exp(modelerror)-1),file="Models/Predictions/millet_predictions.csv") # export for mapping
...
head(modelerror) #make sure it worked honeyyyy
write.csv(exp(modelerror)-1),file="Models/Predictions/rapeseed_predictions.csv") # export for mapping
...
head(modelerror) #make sure it worked honeyyyy
write.csv(exp(modelerror)-1),file="Models/Predictions/rice_predictions.csv") # export for mapping
...
head(modelerror) #make sure it worked honeyyyy
write.csv(exp(modelerror)-1),file="Models/Predictions/rye_predictions.csv") # export for mapping
...
head(modelerror) #make sure it worked honeyyyy
write.csv(exp(modelerror)-1),file="Models/Predictions/Sorghum_predictions.csv") # export for mapping
...
head(modelerror) #make sure it worked honeyyyy
write.csv(exp(modelerror)-1),file="Models/Predictions/Soybean_predictions.csv") # export for mapping
...
head(modelerror) #make sure it worked honeyyyy
write.csv(exp(modelerror)-1),file="Models/Predictions/Sunflower_predictions.csv") # export for mapping
...
head(modelerror) #make sure it worked honeyyyy
write.csv(exp(modelerror)-1),file="Models/Predictions/Wheat_predictions.csv") # export for mapping
