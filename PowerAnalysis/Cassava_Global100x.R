...
cassava.100x
write.csv(cassava.spatial$predictions, file="./PowerAnalysis/Cassava_Global100xPred.csv")
write.csv(cassava.spatial$residuals$values, file="./PowerAnalysis/Cassava_Global100xresid.csv")
write.csv(cassava.spatial$variable.importance, file="./PowerAnalysis/Cassava_Global100xVarImp.csv")
write.csv(cassava.spatial$performance, file="./PowerAnalysis/Cassava_Global100xpreformance.csv")
write.csv(cassava.curves.df, file="./PowerAnalysis/Cassava_Global100xcurves.csv")
