...
#write.csv(output.low,file="Low_Fert_Analyses/RandomGCOs/millet_low50percNull.csv")
```
...
fishnet.low.rapeseed<-subset(fishnet.m, fishnet.m$rapeseed_FertMean < 6.54) #subset below 50% of data
...
#write.csv(output.low,file="Low_Fert_Analyses/RandomGCOs/rapeseed_low50percNull.csv")
```
...
fishnet.low.rice<-subset(fishnet.m, fishnet.m$rice_FertMean < 4.57) #subset below 50% of data
...
#write.csv(output.low,file="Low_Fert_Analyses/RandomGCOs/rice_low50percNull.csv")
```
...
#write.csv(output.low,file="Low_Fert_Analyses/RandomGCOs/rye_low50percNull.csv")
```
...
#write.csv(output.low,file="Low_Fert_Analyses/RandomGCOs/sorghum_low50percNull.csv")
```
...
#write.csv(output.low,file="Low_Fert_Analyses/RandomGCOs/soybean_low50percNull.csv")
```
...
#write.csv(output.low,file="Low_Fert_Analyses/RandomGCOs/sunflower_low50percNull.csv")
```
