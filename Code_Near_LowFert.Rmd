...
fishnet.low.rye<-subset(fishnet.m, fishnet.m$rye_FertMean < 8.32) #subset below 50% of data
...
fishnet.low.sorghum<-subset(fishnet.m, fishnet.m$sorghum_FertMean < 5.035) #subset below 50% of data
